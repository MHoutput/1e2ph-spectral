...
calc = PhonopyCommensurateCalculation(
    data_folder+"/LiF_a4.004_E0.0_super666.yaml", 
...
# colorLO = (0.3, 0.3, 0.3)
# hatchplot_styles = [
#     dict(color1=colorTA, color2=colorTA, label_shift = 0, hatch='//'),
#     dict(color1=colorTA, color2=colorLA, label_shift = 0, hatch='//'),
#     dict(color1=colorTA, color2=colorTO, label_shift = 0, hatch='\\\\'),
#     dict(color1=colorTA, color2=colorLO, label_shift = 0, hatch='//'),
#     dict(color1=colorLA, color2=colorLA, label_shift = 0, hatch='//'),
#     dict(color1=colorLA, color2=colorTO, label_shift = 0, hatch='//'),
...
# calc = PhonopyCommensurateCalculation(
#     data_folder+"/KTaO3_a3.99_E0.0_super444.yaml",
